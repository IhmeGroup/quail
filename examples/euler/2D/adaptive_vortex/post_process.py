...
plot.plot_solution(mesh, physics, solver, "Density", plot_numerical=True,
		...
		show_elem_IDs=False, levels=np.linspace(.5, 1.2, 10))
# Save figure
plot.save_figure(file_name='density', file_type='png', crop_level=2)
...
# Save figure
plot.save_figure(file_name='line', file_type='png', crop_level=2)
